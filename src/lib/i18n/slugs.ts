...
const CALCULATOR_SLUGS: Record<string, Record<string, string>> = {
  de: {
    ...
    'body-fat-calculator': 'koerperfett-rechner',
    'lean-body-mass-calculator': 'fettfreie-masse-rechner',
    'one-rep-max-calculator': '1rm-rechner',
    'pace-calculator': 'tempo-rechner',
    'running-pace-calculator': 'lauf-pace-rechner',
    'heart-rate-zone-calculator': 'herzfrequenz-zonen-rechner',
    'pregnancy-due-date-calculator': 'geburtstermin-rechner',
    'ovulation-calculator': 'eisprung-rechner',
    'protein-intake-calculator': 'eiweissbedarf-rechner',
    ...
    'exponent-calculator': 'exponentenrechner',
    'log-calculator': 'logarithmus-rechner',
    'matrix-calculator': 'matrizenrechner',
    'determinant-calculator': 'determinanten-rechner',
    'quadratic-calculator': 'quadratische-gleichung-rechner',
    'standard-deviation-calculator': 'standardabweichung-rechner',
    'prime-number-calculator': 'primzahlenrechner',
    'gcf-calculator': 'ggt-rechner',
    'lcm-calculator': 'kgv-rechner',
    'permutation-combination-calculator': 'permutations-und-kombinationsrechner',
    ...
    'vat-calculator': 'umsatzsteuer-rechner',
    'margin-calculator': 'margenrechner',
    'profit-calculator': 'gewinnrechner',
    'commission-calculator': 'provisionsrechner',
    'markup-calculator': 'aufschlagsrechner',
    'debt-to-income-calculator': 'schulden-einkommen-rechner',
    'break-even-calculator': 'break-even-rechner',
    'cagr-calculator': 'cagr-rechner',
